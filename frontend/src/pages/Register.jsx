...
const Register = () => {
	...
	return (
		<div className="flex items-center justify-center min-h-screen p-4">
			<main className="w-full max-w[420px] bg-surface backdrop-blur-xl border border-surface-border rounded-2xl p-8 shadow-lg animate-[fadeIn_0.4s_ease_forwards]">
				...
				<p className="text-center mt-6 text-slate-400">
					Already have an account? <Link to="/login" className="text-primary hover:text-primary-hover hover:text-shadow-[0_0_8px_rgba(99,102,241,0.4)] transition-all duration-200">Sign in</Link>
				</p>
			</main>
		</div>
	);
